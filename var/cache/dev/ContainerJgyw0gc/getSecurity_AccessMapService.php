...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/panel-administrador'), [0 => 'ROLE_Administrador'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/panel-cliente'), [0 => 'ROLE_Cliente'], NULL);
